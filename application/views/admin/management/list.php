                          ...
                          <table class="table table-bordered">
                              ...
                              <tbody>
                                  ...
                                  <tr>
                                      ...
                                      <td><?= $manage['short_bio']; ?></td>
                                      <td><img src="<?= base_url('uploads/management/' . $manage['management_image']); ?>" width="100"></td>
                                      <td>
                                          <input type="checkbox" name="featured" class="is-active-checkbox"
                                            data-id="<?= $manage['id']; ?>"
                                            <?= $manage['is_active'] ? 'checked' : '' ?>>
                                      </td>
                                      <td>
                                          <!-- <a target="_blank"
                                              href="<?= base_url('certification-training/'.$category['slug']); ?>"
                                              class="btn">View</a> -->
                                          <a href="<?php echo base_url();?>admin/management/edit/<?= $manage['id']; ?>"
                                              class="btn">Edit</a>
