          ...
          <div class="admin-main-content">
              ...
              <div class="container-fluid">
                  ...
                  <div class="row meta-section">
                      <div class="col-12">
                          <h4 class="meta-section__title">Infrastructure Meta Information</h4>
                  ...
                  <div class="row">
                      <div class="col-12">
                         <h4 class="meta-section__title">Infrastructure Information</h4>
                          <div class="admin-main-content__section">
                            
                              <div class="mb-3">
                                  <label class="form-label">Name</label>
                                  <input type="text" class="form-control" id="infrastructure_title" name="infrastructure_title">
                                  <div class="error" id="error_infrastructure_title" style="color:red;"></div>
                              </div>
                              <div class="mb-3">
                                  <label class="form-label">Description</label>
                                  <textarea class="form-control summernote" id="infrastructure_description" name="infrastructure_description"
                                      rows="3"></textarea>
                                  <div class="error" id="error_infrastructure_description" style="color:red;"></div>
                              </div>
                              <div class="mb-3">
                                  <label class="form-label">Image</label>
                                  <input type="file" class="form-control" id="infrastructure_image" name="infrastructure_image">
                                  <div class="error" id="error_infrastructure_image" style="color:red;"></div>
                              </div>
                ...
                <div class="text-end">
                <button type="submit" id="save_infrastucture" class="btn btn-success">Save Infrastructure</button>
