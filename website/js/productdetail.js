  ...
  $(document).on("click", ".send-contact", function (e) {
    ...
    let valid = true;
     ...
     valid &= validateField({
        ...
        errorId: "#error_contact_name",
        message: "Name is required.",
    });
    valid &= validateField({
        fieldId: "#contact_email",
        errorId: "#error_contact_email",
        message: "Email is required.",
    });
    valid &= validateField({
        fieldId: "#contact_phone",
        errorId: "#error_contact_phone",
        message: "Phone is required.",
    });
   
    valid &= validateField({
        fieldId: "#contact_message",
        errorId: "#error_contact_message",
        message: "message is required.",
    });

    /** email validation */
    const emailVal = $("#contact_email").val().trim();
    const emailError = $("#error_contact_email");
    ...
    /** phone validation */
    const phoneVal = $("#contact_phone").val().trim();
    const phoneError = $("#error_contact_phone");
   ...
   const formData = new FormData();
    ...
    formData.append("phone_no", $("#contact_phone").val());
